...
<head>
    ...
    <title>У вас новое сообщение!</title>
    <meta name="description" content="Новое сообщение с сайта">
    <style type="text/css">
                            ...
                            <table width="95%" border="0"  cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#455056; font-weight:800; margin:0;font-size:22px;font-family:'Rubik',sans-serif;">У вас новое сообщение!</h1>
                                        <span
                                            style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:4px solid green; width:100px;"></span>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;"><span style="font-weight: 600">Имя: </span>{{ $username }}</p>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;"><span style="font-weight: 600">Email: </span>
                                            <a href="mailto:{{ $useremail }}">{{ $useremail }}</a></p>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;"><span style="font-weight: 600">Телефон: </span><a href="tel:{{ $userphone }}"></a></p>{{ $userphone }}</p>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;"><span>Сообщение:</span>{{ $usertext }}</p>
                                    </td>
                                    <tr>
                                        <td style="height:40px;">&nbsp;</td>
                                    </tr>
