...
<header id="header">
    <div class="logo">
        <a href="/" aria-label="Логотип ГК «Дива»">
            ...
            <svg version="1.1" id="logo_id" xmlns="http://www.w3.org/2000/svg" x="0" y="0"
                viewBox="0 0 507.3 116.7" style="max-width:140px" xml:space="preserve">
    ...
    <label for="menuToggle" class="menu-icon"><svg xmlns="http://www.w3.org/2000/svg" style="widht:1.5rem; height:1.5rem" fill="green" style="max-widht:2rem"
                ...
                @foreach ($item->repeater as $menuitem)
                    <li @if ($menuitem['subrep']) class="master" @endif><a
                        ...
                        @if ($menuitem['subrep'])
                            ...
                            <label for="{{ Illuminate\Support\Str::slug($menuitem['menu_title']) }}"><svg
                                    width="10" height="6" viewBox="0 0 10 6" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="sc-1s30kz8-14 blwLTc">
